...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/p2.css">
    <!-- media-queries -->
...
${error}
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active" style="background-image: url(img2/sonatrach-1.jpg);">
                    ...
                    <h1 data-wow-duration="500ms" data-wow-delay="500ms" class="wow bounceInDown animated" style="text-decoration: center;">Choisissez le mois :</h1>
                    <div class="datepicker ">
                        <form method="get" action="BP">
                        <div data-wow-duration="1000ms" class="wow slideInLeft animated " class="select-date ">
    ...
    <button data-wow-duration="1000ms " class="wow slideInRight animated " type="submit">valider</button>
                        </form>
                    </div>

...
<div class="container-fluid p-0">
    ...
    <section id="home-row" data-scroll-section>
        <form method="get" action="ATCEmp">
            <h1 class="text">choisir la date</h1>
            ...
            <div class="dates-wrapper group">
                ...
                <div class="field clearfix date-range-start date-wrapper">
                    <div class="label">
                        <label for="datepicker-end">Date de reprise de travail:</label>
                    </div>
                    <div class="input">
                ...
                <div class="field clearfix date-range-start date-wrapper">
                    <div class="label">
                        <label for="baseSS-start">Date de debut baseSS:</label>
                    </div>
                    <div class="input">
                ...
                <div class="field clearfix date-range-start date-wrapper">
                    <div class="label">
                        <label for="baseSS-end">Date de fin baseSS:</label>
                    </div>
                    <div class="input">
